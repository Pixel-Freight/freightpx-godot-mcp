...
export class GodotServer {
   ...
   */
  public createErrorResponse(message: string, possibleSolutions: string[] = []): any {
    // Log the error
   ...
   */
  public validateClassName(name: string): boolean {
   ...
   */
  public async getProjectStructure(projectPath: string): Promise<any> {
    try {
  ...
  private setupToolHandlers() {
      import('./tools/registry.js').then(m => m.setupToolHandlers(this));
  }
